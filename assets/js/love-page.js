...
async function loadPageData() {
    try {
        ...
        console.log('[NOVACOEUR] Appel API:', `${window.API_BASE_URL}/api/pages/${pageId}`);
        ...
        document.body.innerHTML = '<div style="text-align:center; padding:50px;"><h2>Erreur de chargement</h2><p>Impossible de charger la page.</p><a href="index.html">Retour à l\'accueil</a></div>';
        return null;
    }
}
